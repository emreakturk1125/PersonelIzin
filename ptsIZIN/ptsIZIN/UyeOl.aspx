<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UyeOl.aspx.cs" Inherits="ptsIZIN.UyeOl" %>
                ...
                <tr>
                    ...
                    <td>
                        <a href="Login.aspx">
                          ...
                          <%--  <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove-circle"></span>Çıkış</button></a>--%>

                       <%-- <span class="icon-input-btn"><span class="glyphicon glyphicon-ok-circle" style="color: white"></span>
                            <asp:Button ID="btnUyeOl" runat="server" CssClass="btn  btn-primary" Text="Kaydet" OnClick="btnUyeOl_Click" />
                        </span>--%>
                       
                            <asp:Button ID="Button1" runat="server" CssClass="btn  btn-primary" Text="Kaydet" OnClick="btnUyeOl_Click" />
